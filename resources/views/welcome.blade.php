                ...
                <div class="content">
                    <div style="margin-top:10px ">
                        <audio id="music" controls autoplay>
                            <source src="/music/y2mate.com-Title ScreenSonictheHedgehog28bitOST.mp3" type="audio/mp3">
                        </audio>
                    </div>
                    ...
                    <div id="howtobuy">
                      ...
                      <div id="about" class="card mb-3" style="max-width: 100%;">
                        <div class="row g-0">
                          ...
                          <div class="col-md-4">
                            <img src="/gif/snitch.gif" class="img-fluid rounded-start" alt="...">
                          </div>
                        </div>
                        <img src="/gif/Comp-100.gif" width="300" height="300" class="img-fluid rounded-start" alt="...">
                      </div>
